        ...
        data() {
            return {
                ...
                events: {
                    ...
                    7:{id: 7, type: 'LOG_EVENT_CONTAINER_CREATE', text: '申请容器'},
                    8:{id: 8, type: 'LOG_EVENT_CONTAINER_DELETE', text: '删除容器'},
                    9:{id: 9, type: 'LOG_EVENT_CONTAINER_RENEW', text: '续期容器'},
                    10:{id: 10, type: 'LOG_EVENT_CONTAINER_MAX', text: '容器数量达到最大值'},
                    11:{id: 11, type: 'LOG_EVENT_CONTAINER_CREATE_REPEAT', text: '申请已经申请过容器的题目'},
                    12:{id: 12, type: 'LOG_EVENT_CONTAINER_UNMATCHED_TYPE', text: '操作不需要申请容器的题目'},
                    13:{id: 13, type: 'LOG_EVENT_CONTAINER_INVALID', text: '操作没有申请过的容器'},
                    14:{id: 14, type: 'LOG_EVENT_CONTAINER_ERROR', text: '容器处理过程中出错'},
                    15:{id: 15, type: 'LOG_EVENT_CONTAINER_QUERY', text: '查询容器信息'},
                    999:{id: 999, text: '全部'},
                },
                filter_content: '',
                filter_type: 999,
